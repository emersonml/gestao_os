...
<body>
    ...
    <div class="row-fluid">
        <div id="footer" class="span12" style="padding: 10px">
            <a class="pecolor" href="https://github.com/emersonml" target="_blank">
                <?= date('Y') ?> &copy; Emerson Marques - <?= $this->config->item('app_name') ?> - Versão: <?= $this->config->item('app_version'); ?>
            </a>
        </div>
    </div>
